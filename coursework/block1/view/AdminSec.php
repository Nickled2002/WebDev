			...
			<div class="row">
                ...
                <?php
					...
					for ($i=0; $i< sizeof($item); $i++) {
						...
						echo '<p>Stock : '.$item[$i] -> stock.'</p>';
						echo '</div>' ;
						echo '<div class="card-footer">' ;
						echo '<a href="UpdateStock.php?id=',urlencode($id),'" class="btn btn-primary" style="margin-right:16px">Update Stock</a>' ;
						echo '<a href="DeleteItem.php?id=',urlencode($id),'" class="btn btn-primary" style="margin-right:16px">Delete Item</a>' ;
						echo '</div>' ;
						echo '</div>' ;
						echo '</div>' ;
					}
