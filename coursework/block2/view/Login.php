...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){//check if the user is already logged in
    if (isset($_SESSION["admin"])&& $_SESSION["admin"] === true) {//check if the user is an admin
        header("location : AdminSec.php");//redirect to admin page
        exit;
    }
    else
    {
	...
	<body>
		...
		<div class="jumbotron text-center" style="background-color:black;margin-bottom:0;">
			...
			<div class="card-img-overlay">
					<h1 class="card-title">Cmp306 Web Services Development Block 2</h1>
