...
<html lang="en">
    ...
    <div id="header" class="card text-center">
        ...
        <div class="row">
            ...
            <h1> Enter the Story new details</h1>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
            <label for="storyId">Story id:</label><br>
            <input type="text" id="storyId" name="storyId" class="form-control" value="<?php echo $addId ?>" readonly><br><br>
